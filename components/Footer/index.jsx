...
const Footer = () => {
  return (
    <footer className='dark:bg-dark dark:text-light dark:border-gray-600 sticky flex flex-col items-center justify-center w-full p-4 text-base text-center bg-white border-t-2 border-gray-200'>
      <h5>
