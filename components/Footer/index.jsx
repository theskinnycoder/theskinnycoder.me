...
const Footer = () => {
  return (
    <footer className='dark:bg-dark dark:text-light dark:border-gray-600 sticky flex flex-col items-center justify-center w-full px-4 py-10 text-lg text-center bg-white border-t-2 border-gray-200'>
      <h5>
