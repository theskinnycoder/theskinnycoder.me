    ...
    >
      <div className='container p-3 mx-auto text-center'>
        ...
        <div className='lg:grid-cols-4 lg:w-full grid w-4/5 grid-cols-1 gap-5 mx-auto mt-10'>
          {/* Stock & Design */}
          <div className='dark:bg-dark bg-opacity-10 hover:shadow-2xl hover:-translate-y-1 dark:border-white dark:border-2 bg-light flex flex-col items-center justify-start p-2 space-y-2 transition duration-300 ease-in-out transform rounded shadow-xl'>
            ...
            <a
              ...
              target='_blank'
              className='hover:bg-dark dark:hover:bg-light dark:hover:text-black hover:text-light flex items-center p-1 text-lg font-semibold rounded'
            >
          ...
          {/* Development */}
          <div className='dark:bg-dark bg-opacity-10 hover:shadow-2xl hover:-translate-y-1 dark:border-white dark:border-2 bg-light flex flex-col items-center justify-start p-2 space-y-2 transition duration-300 ease-in-out transform rounded shadow-xl'>
            <h4 className='md:text-3xl text-2xl font-semibold underline uppercase'>Development</h4>
            <a
          ...
          {/* Setup */}
          <div className='dark:bg-dark bg-opacity-10 hover:shadow-2xl hover:-translate-y-1 dark:border-white dark:border-2 bg-light flex flex-col items-center justify-start p-2 space-y-2 transition duration-300 ease-in-out transform rounded shadow-xl'>
            <h4 className='md:text-3xl text-2xl font-semibold underline uppercase'>Setup</h4>
            <div className='hover:bg-dark dark:hover:bg-light dark:hover:text-black hover:text-light group flex items-center p-1 text-lg font-semibold rounded'>
              <SiAsus className='mr-1.5 w-auto h-14 text-[#15138C] group-hover:text-light' />
              TUF-Gaming FX-504
            </div>
            <div className='hover:bg-dark dark:hover:bg-light dark:hover:text-black hover:text-light group flex items-center p-1 text-lg font-semibold rounded'>
              <SiKde className='mr-1.5 text-[#20A0F1]' />
