const Timeline = () => {
  return (
    <div className='bg-tuna-100 dark:bg-tuna-900 bg-opacity-10 min-h-screen'>
        ...
        <div className='container w-full h-full mx-auto'>
          <div className='wrap relative h-full p-10 overflow-hidden'>
            ...
            <div className='hover:-translate-y-1 flex flex-row-reverse items-center justify-between w-full mb-8 transition duration-300 ease-in-out transform'>
              ...
              <div className='bg-tuna-700 dark:bg-tuna-400 sm:flex items-center order-1 hidden w-10 h-10 rounded-full shadow-2xl'>
                <h1 className='mx-auto text-xl font-semibold text-light'>4</h1>
              </div>
              <div className='bg-tuna-900 sm:w-5/12 hover:shadow-2xl order-1 w-3/4 px-6 py-4 rounded-lg shadow-xl'>
                <h3 className='text-xl font-bold text-light'>First Internship</h3>
                <h4 className='mb-3 text-sm font-semibold text-light'>April 2021</h4>
                <p className='text-lg leading-snug tracking-wide text-light text-opacity-100'>
            ...
            <div className='hover:-translate-y-1 flex items-center justify-between w-full mb-8 transition duration-300 ease-in-out transform'>
              <div className='order-1 w-5/12'></div>
              <div className='bg-tuna-700 dark:bg-tuna-400 sm:flex items-center order-1 hidden w-10 h-10 rounded-full shadow-2xl'>
                <h1 className='mx-auto text-xl font-semibold text-light'>3</h1>
              </div>
              <div className='sm:w-5/12 hover:shadow-2xl order-1 w-3/4 px-6 py-4 bg-white rounded-lg shadow-xl'>
                <h3 className='dark:text-tuna-100 text-tuna-900 text-xl font-bold'>
                  Freelancing 101
                </h3>
                <h4 className='dark:text-tuna-100 text-tuna-900 mb-3 text-sm font-semibold'>
                  2021
                </h4>
            ...
            <div className='hover:-translate-y-1 flex flex-row-reverse items-center justify-between w-full mb-8 transition duration-300 ease-in-out transform'>
              <div className='order-1 w-5/12'></div>
              <div className='bg-tuna-700 dark:bg-tuna-400 sm:flex items-center order-1 hidden w-10 h-10 rounded-full shadow-2xl'>
                <h1 className='mx-auto text-xl font-semibold text-light'>2</h1>
              </div>
              <div className='bg-tuna-900 sm:w-5/12 hover:shadow-2xl order-1 w-3/4 px-6 py-4 rounded-lg shadow-xl'>
                <h3 className='text-xl font-bold text-light'>Started YouTube Channel</h3>
                <h4 className='mb-3 text-sm font-semibold text-light'>March 2020</h4>
                <p className='text-lg leading-snug tracking-wide text-light text-opacity-100'>
            ...
            <div className='hover:-translate-y-1 flex items-center justify-between w-full mb-8 transition duration-300 ease-in-out transform'>
              <div className='order-1 w-5/12'></div>
              <div className='bg-tuna-700 dark:bg-tuna-400 sm:flex items-center order-1 hidden w-10 h-10 rounded-full shadow-2xl'>
                <h1 className='mx-auto text-xl font-semibold text-light'>1</h1>
              </div>
              <div className='sm:w-5/12 hover:shadow-2xl order-1 w-3/4 px-6 py-4 bg-white rounded-lg shadow-xl'>
                <h3 className='dark:text-tuna-100 text-tuna-900 text-xl font-bold'>GVPCE(A)</h3>
                <h4 className='dark:text-tuna-100 text-tuna-900 mb-3 text-sm font-semibold'>
            ...
            <div className='hover:-translate-y-1 flex flex-row-reverse items-center justify-between w-full mb-8 transition duration-300 ease-in-out transform'>
              <div className='order-1 w-5/12'></div>
              <div className='bg-tuna-700 dark:bg-tuna-400 sm:flex items-center order-1 hidden w-10 h-10 rounded-full shadow-2xl'>
                <h1 className='mx-auto text-xl font-semibold text-light'>0</h1>
              </div>
              <div className='bg-tuna-900 sm:w-5/12 hover:shadow-2xl order-1 w-3/4 px-6 py-4 rounded-lg shadow-xl'>
                <h3 className='text-xl font-bold text-light'>Started Web Development</h3>
                <h4 className='mb-3 text-sm font-semibold text-light'>2014-16, High School</h4>
                <p className='text-lg leading-snug tracking-wide text-light'>
