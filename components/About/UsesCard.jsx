const UsesCard = ({ usesSection }) => {
  return (
    <div className='dark:bg-dark bg-opacity-10 hover:shadow-2xl hover:-translate-y-1 dark:ring-1 dark:ring-light bg-light dark:divide-gray-200 flex flex-col items-center justify-start p-2 space-y-2 transition duration-300 ease-in-out transform divide-y divide-black rounded shadow-xl'>
