const UsesCard = ({ usesSection }) => {
  return (
    <div className='dark:bg-black hover:shadow-2xl hover:-translate-y-1 dark:ring-1 dark:ring-light bg-light flex flex-col items-center justify-start p-2 space-y-2 transition duration-300 ease-in-out transform divide-y divide-pink-300 rounded shadow-xl'>
