...
const VideoItem = ({ video }) => {
  return (
    <div className="group hover:scale-105 hover:shadow-2xl dark:bg-black dark:bg-opacity-95 dark:text-white dark:shadow-none dark:hover:shadow-2xl bg-brand-light dark:ring-2 dark:ring-brand w-10/12 h-full mx-auto text-left transition duration-500 ease-in-out transform shadow-xl">
